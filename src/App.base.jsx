...
const GUIA_OPERADOR_PASSOS = [
  ...
  },
  {
    ...
    texto: 'Se precisar ajustar informa��es, clique em "Editar" dentro da OS.',
  },
];
...
const CFOP_SAIDA_TABLE = [
  {
    cfop: '5101',
    descricaoFiscal: 'Venda de produ��o do estabelecimento',
  ...
  {
    cfop: '6101',
    descricaoFiscal: 'Venda de produ��o do estabelecimento (interestadual)',
  ...
  {
    cfop: '6107',
    descricaoFiscal: 'Venda de produ��o fora do estado sem destaque de ICMS',
    pratica: 'Venda interestadual com tratamento fiscal espec�fico',
    faturamento: '?? Depende (normalmente n�o)',
  },
  {
    cfop: '5401',
    descricaoFiscal: 'Venda de produ��o do estabelecimento com ST',
  ...
  {
    cfop: '6401',
    descricaoFiscal: 'Venda de produ��o do estabelecimento com ST (interestadual)',
  ...
  {
    cfop: '5405',
    descricaoFiscal: 'Transfer�ncia de produ��o do estabelecimento com ST',
  ...
  {
    cfop: '5201',
    descricaoFiscal: 'Devolu��o de compra para industrializa��o',
    pratica: 'Retorno de mercadoria ao fornecedor',
    faturamento: '? N�o',
  },
  {
    cfop: '6910',
    descricaoFiscal: 'Bonifica��o / doa��o / brinde',
    pratica: 'Sa�da sem cobran�a',
    faturamento: '? N�o',
  },
  {
    cfop: '6915',
    descricaoFiscal: 'Remessa simb�lica / retorno de industrializa��o',
    pratica: 'Ajuste fiscal/log�stico',
    faturamento: '? N�o',
  },
  {
    cfop: '6901',
    descricaoFiscal: 'Remessa para industrializa��o fora do estabelecimento',
    pratica: 'Envio para industrializa��o em terceiro',
    faturamento: '? N�o',
  },
];
...
export default function App() {
  ...
  const handleExcluirOs = async (ordem) => {
    ...
    try {
      ...
      alert('Erro ao excluir a ordem de servi�o.');
    }
  };
  ...
  const handleExcluirTodasOs = async () => {
    ...
    if (!window.confirm('Tem certeza que deseja EXCLUIR TODAS as ordens de servi�o? Esta a��o n�o pode ser desfeita!')) return;
    ...
    try {
      ...
      alert('Erro ao excluir as ordens de servi�o.');
    }
  };
  ...
  // �ltimos 10 dias de faturamento (independente do m�s selecionado)
      ...
      <main className={`flex-1 px-4 md:px-6 ${abaAtiva === 'dashboard-tv' ? 'pb-4' : 'pb-24 md:pb-8'}`}>
        {abaAtiva !== 'faturamento' && abaAtiva !== 'executivo' && abaAtiva !== 'dashboard-tv' && (
          ...
          <div>
            ...
            {abaAtiva !== 'custos' && (
              <p className="text-slate-500 mt-1">Status da opera��o em {new Date().toLocaleDateString('pt-BR')}</p>
            )}
          </div>
          ...
          {abaAtiva === 'executivo' && (
            <div className="space-y-8 animate-in fade-in duration-700">
                ...
                <div className="relative flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 min-w-[340px]">
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                      <p className="text-[11px] uppercase tracking-[0.2em] text-slate-400 font-semibold">Presen�a hoje</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
                ...
                ].filter((kpi) => !['Faltas hoje', 'FǸrias hoje'].includes(kpi.titulo)).map((kpi) => (
                  <CardInformativo
                    key={kpi.titulo}
                    titulo={kpi.titulo}
                    valor={kpi.valor}
                        ...
                        return (
                          <div className="space-y-3">
                            <div className="flex flex-wrap items-center gap-3 text-[11px] text-slate-400">
                              <span>Intera��o: passe o mouse para ver detalhes, clique para abrir o ABC.</span>
                              {paretoAtivo && (
                                      ...
                                      <table className="w-full text-left text-xs">
                                        <thead className="sticky top-0 bg-slate-900/90 text-slate-400 uppercase tracking-wider">
                                          <tr>
                                            ...
                                            <th className="px-5 py-3">Descri��o</th>
